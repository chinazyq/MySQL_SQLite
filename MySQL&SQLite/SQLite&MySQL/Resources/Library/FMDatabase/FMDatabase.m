...
#define kDBFileName @"zhangyqV1.db"
...
+ (id)sharedDatabase
{
    return FMDBReturnAutoreleased([[self alloc] init]);
...
- (instancetype)init {
    ...
    NSString *filePath = [documentsDirectory stringByAppendingPathComponent:kDBFileName];
